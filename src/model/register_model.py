...
def register_model_and_transformer(model_name: str, model_info: dict, transformer_name: str, transformer_path: str):
    """Register the model and feature transformer to the MLflow Model Registry."""
    try:
        ...
        # Log the Feature Transformer as an artifact
        mlflow.log_artifact(transformer_path, artifact_path="preprocessing")

        # Register Feature Transformer in MLflow Model Registry
        ...
        # Transition the Feature Transformer to "Staging"
        client.transition_model_version_stage(
            name=transformer_name,
            version=transformer_version.version,
            stage="Staging"
        )
        logging.debug(f'Feature Transformer {transformer_name} version {transformer_version.version} registered and transitioned to Staging.')
...
def main():
    try:
        ...
        model_name = "my_model"
        transformer_name = "feature_transformer"
        transformer_path = "models/feature_transformer.pkl"  # Ensure this file exists
